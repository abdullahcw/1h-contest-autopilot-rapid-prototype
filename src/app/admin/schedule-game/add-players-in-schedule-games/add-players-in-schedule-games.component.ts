...
@Component({
  selector: 'app-add-players-in-schedule-games',
  templateUrl: './add-players-in-schedule-games.component.html',
  styleUrls: ['./add-players-in-schedule-games.component.scss']
})
export class AddPlayersInScheduleGamesComponent implements OnInit, OnDestroy {
  menuList: any[];
  ...
  search_filters = [
    {
      'filter': Constants.CUSTOM_AUDIENCE, value: this.translate.instant('custom_audience'), 
      'is_text_search': true, 
      'is_list_search': true,
      'placeholder': PlaceholderText.AUDIENCE_NAME, 
